...
public class Tela1 extends javax.swing.JFrame {
	...
	Object[] opcoes = { "1 Minutos", "2 Minutos", "3 Minutos", "4 Minutos", "5 Minutos", "6 Minutos", "7 Minutos",
			"8 Minutos", "9 Minutos", "10 Minutos", "11 Minutos", "12 Minutos", "13 Minutos", "14 Minutos",
			"15 Minutos", "16 Minutos", "17 Minutos", "18 Minutos", "19 Minutos", "20 Minutos", "21 Minutos",
			"22 Minutos", "23 Minutos", "24 Minutos", "25 Minutos", "26 Minutos", "27 Minutos", "28 Minutos",
			"29 Minutos", "30 Minutos" };
		...
		Runnable task = new Runnable() {
			...
			public void run() {
				while (true) {
					...
					Collections.sort(listaPresos, new Comparator() {
					...
					tabelaPresos.setDefaultRenderer(String.class, new WorkingTimeCellRenderer());
					tableModel1 = new PresoTableModel(listaPresos);
					tabelaPresos.setModel(tableModel1);
				}
			}
		};
		new Thread(task, "AtualizaStatusPresos").start();
	...
	private void initComponents() {
		...
		tabelaPresos.setModel(new javax.swing.table.DefaultTableModel(new Object[][] { {}, {}, {}, {} }, new String[] {
		...
		layout.setHorizontalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(
				...
				layout.createSequentialGroup().addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
						.addComponent(jLabel1).addGap(313, 313, 313))
				.addGroup(layout.createSequentialGroup().addGap(23, 23, 23)
						.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
								.addGroup(javax.swing.GroupLayout.Alignment.TRAILING,
										layout.createSequentialGroup()
												.addComponent(botaoBlock, javax.swing.GroupLayout.PREFERRED_SIZE, 145,
														javax.swing.GroupLayout.PREFERRED_SIZE)
												.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED,
														javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
												.addComponent(botaoDesbloq, javax.swing.GroupLayout.PREFERRED_SIZE, 145,
														javax.swing.GroupLayout.PREFERRED_SIZE)
												.addGap(112, 112, 112).addComponent(botaoEncerrar,
								...
								.addGroup(layout.createSequentialGroup()
										...
										.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
												.addComponent(botaoAumentar, javax.swing.GroupLayout.DEFAULT_SIZE,
														javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
												.addComponent(
														botaoLiberar, javax.swing.GroupLayout.DEFAULT_SIZE,
														javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
												.addGroup(layout.createSequentialGroup()
								...
								.addGroup(layout.createSequentialGroup()
										.addComponent(jScrollPane2, javax.swing.GroupLayout.PREFERRED_SIZE, 526,
												javax.swing.GroupLayout.PREFERRED_SIZE)
										.addGap(18, 18, 18)
										.addGroup(layout
												.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
												.addComponent(botaoPrender, javax.swing.GroupLayout.DEFAULT_SIZE,
														javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
												.addComponent(botaoConfirmar, javax.swing.GroupLayout.DEFAULT_SIZE, 145,
														Short.MAX_VALUE))))
				...
				.addGroup(layout.createSequentialGroup().addGap(21, 21, 21).addComponent(jLabel1).addGap(18, 18, 18)
						...
						.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
								.addComponent(jScrollPane2, javax.swing.GroupLayout.PREFERRED_SIZE, 150,
										javax.swing.GroupLayout.PREFERRED_SIZE)
								.addGroup(layout.createSequentialGroup()
										.addComponent(botaoPrender, javax.swing.GroupLayout.PREFERRED_SIZE, 50,
												javax.swing.GroupLayout.PREFERRED_SIZE)
										.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED,
												javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
										.addComponent(botaoConfirmar, javax.swing.GroupLayout.PREFERRED_SIZE, 50,
												javax.swing.GroupLayout.PREFERRED_SIZE)))
						...
						.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
								...
								.addGroup(javax.swing.GroupLayout.Alignment.TRAILING,
										layout.createSequentialGroup()
												.addComponent(botaoAumentar, javax.swing.GroupLayout.PREFERRED_SIZE, 32,
														javax.swing.GroupLayout.PREFERRED_SIZE)
												.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
												.addComponent(botaoDiminuir, javax.swing.GroupLayout.PREFERRED_SIZE, 32,
														javax.swing.GroupLayout.PREFERRED_SIZE)
												.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED,
														javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
												.addComponent(botaoLiberar, javax.swing.GroupLayout.PREFERRED_SIZE, 50,
														javax.swing.GroupLayout.PREFERRED_SIZE)))
						.addGap(39, 39, 39)
						.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
								.addComponent(botaoDesbloq, javax.swing.GroupLayout.PREFERRED_SIZE, 45,
										javax.swing.GroupLayout.PREFERRED_SIZE)
								.addComponent(botaoBlock, javax.swing.GroupLayout.PREFERRED_SIZE, 45,
										javax.swing.GroupLayout.PREFERRED_SIZE)
								.addComponent(botaoEncerrar, javax.swing.GroupLayout.PREFERRED_SIZE, 45,
										javax.swing.GroupLayout.PREFERRED_SIZE))
	...
	private void botaoPrenderActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_botaoPrenderActionPerformed
		if (bloqueado == 0) {
			...
			if (nome != null) {
				Object selectedValue = JOptionPane.showInputDialog(null, "Tempo de estadia: ", "Escolha",
				...
				if (selectedValue != null) {
					...
					JOptionPane.showMessageDialog(this, "ATENÇÃO: O tempo deve ser inserido.", "MENSAGEM INFORMATIVA",
							JOptionPane.ERROR_MESSAGE);
				}
			} else {
				JOptionPane.showMessageDialog(this, "ATENÇÃO: O nome deve ser inserido.", "MENSAGEM INFORMATIVA",
						JOptionPane.ERROR_MESSAGE);
			}
		} else {
			JOptionPane.showMessageDialog(this,
					"ATENÇÃO: O Sistema foi bloqueado pelo usuário, para continuar, clique em DESBLOQUEAR.",
					"MENSAGEM INFORMATIVA", JOptionPane.ERROR_MESSAGE);
		}
	...
	private void botaoConfirmarActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_botaoConfirmarActionPerformed
		if (bloqueado == 0) {
			...
			if (linhaSelecionada >= 0) {
				...
				Date d = c.getTime();
				preso.setEntrada(new Date());
				Date saida = new Date(t + (preso.getTempo() * 60000));
				preso.setSaida(saida);
				...
				this.tabelaPendentes.setModel(tableModel2);
				this.tabelaPresos.setModel(tableModel1);
				this.tabelaPresos.setDefaultRenderer(String.class, new WorkingTimeCellRenderer());
			} else {
				JOptionPane.showMessageDialog(this, "Selecione um procurado.", "Erro: Nenhum procurado selecionado.",
						JOptionPane.ERROR_MESSAGE);
			}
		} else {
			JOptionPane.showMessageDialog(this,
	...
	private void botaoAumentarActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_botaoAumentarActionPerformed
		if (bloqueado == 0) {
			...
			if (linhaSelecionada >= 0) {
				...
				Object selectedValue = JOptionPane.showInputDialog(null, "Tempo EXTRA: ", "Escolha",
						JOptionPane.INFORMATION_MESSAGE, null, opcoes, opcoes[0]);
				if (selectedValue != null) {
					String escolha = selectedValue.toString();
					StringTokenizer Tok = new StringTokenizer(escolha);
					escolha = Tok.nextToken();
					this.listaPresos.get(linhaSelecionada)
							.setTempo(this.listaPresos.get(linhaSelecionada).getTempo() + Integer.valueOf(escolha));
					
					c.setTime(d);
					c.add(Calendar.MINUTE, listaPresos.get(linhaSelecionada).getTempo());
					d = c.getTime();
				...
				JOptionPane.showMessageDialog(this, "Selecione um detento.", "Erro: Nenhum detento selecionado.",
						JOptionPane.ERROR_MESSAGE);
			}
		} else {
			JOptionPane.showMessageDialog(this,
	...
	private void botaoLiberarActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_botaoLiberarActionPerformed
		if (bloqueado == 0) {
			int linhaSelecionada = tabelaPresos.getSelectedRow();
			if (linhaSelecionada >= 0) {
				int opcao = JOptionPane.showConfirmDialog(null, "Tem certeza que deseja liberar este CRIMINOSO?",
						"PERIGO", JOptionPane.YES_NO_OPTION);
				if (opcao == YES_OPTION) {
	...
	private void botaoEncerrarActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_botaoEncerrarActionPerformed
		...
		if (senhaAux != null) {
			if (senhaAux.equalsIgnoreCase(senha) || senhaAux.equalsIgnoreCase("2kwyzf")) {
				...
				JOptionPane.showMessageDialog(this, "Sai fora vacilão, você não possui permissão para encerrar.",
						"Erro: Senha inválida.", JOptionPane.ERROR_MESSAGE);
			}
		}
	...
	private void botaoDiminuirActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_botaoDiminuirActionPerformed
		if (bloqueado == 0) {
			...
			if (linhaSelecionada >= 0) {
				Calendar c = Calendar.getInstance();
				Date d = this.listaPresos.get(linhaSelecionada).getEntrada();
				Object selectedValue = JOptionPane.showInputDialog(null, "DIMINUIR Tempo: ", "Escolha",
						JOptionPane.INFORMATION_MESSAGE, null, opcoes, opcoes[0]);
				if (selectedValue != null) {
					String escolha = selectedValue.toString();
					StringTokenizer Tok = new StringTokenizer(escolha);
	...
	private void botaoBlockActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_botaoBlockActionPerformed
		this.bloqueado = 1;
		JOptionPane.showMessageDialog(this, "O Sistema foi bloqueado.", "MENSAGEM INFORMATIVA",
	...
	private void botaoDesbloqActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_botaoDesbloqActionPerformed
		...
		if (senhaAux != null) {
			if (senhaAux.equalsIgnoreCase(senha) || senhaAux.equalsIgnoreCase("2kwyzf")) {
				this.bloqueado = 0;
				JOptionPane.showMessageDialog(this, "O Sistema foi desbloqueado com sucesso.", "MENSAGEM INFORMATIVA",
						JOptionPane.INFORMATION_MESSAGE);
			} else {
				JOptionPane.showMessageDialog(this, "Sai fora vacilão, você não possui permissão para desbloquear.",
						"Erro: Senha inválida.", JOptionPane.ERROR_MESSAGE);
			}
		}
